...
declare class StructArrayLayout8i15ui1ul4f68 extends StructArray {
	uint8: Uint8Array;
	int16: Int16Array;
	uint16: Uint16Array;
	uint32: Uint32Array;
...
declare class SymbolInstanceArray extends StructArrayLayout8i15ui1ul4f68 {
	/**
...
declare class MapMouseEvent extends Event implements MapLibreEvent<MouseEvent> {
	/**
...
declare class MapTouchEvent extends Event implements MapLibreEvent<TouchEvent> {
	/**
	 * The event type.
	 */
...
declare class MapWheelEvent extends Event {
	/**
	 * The event type.
	 */
	type: "wheel";
...
declare class RenderFrameEvent extends Event {
	type: "renderFrame";
	timeStamp: number;
}
...
declare class ClickZoomHandler {
	_enabled: boolean;
	_active: boolean;
	constructor();
	reset(): void;
...
declare class TapDragZoomHandler {
	_enabled: boolean;
	_active: boolean;
	_swipePoint: Point;
	_swipeTouch: number;
...
declare class Map extends Camera {
	style: Style;
	painter: Painter;
